...
async def process_image_endpoint(file: UploadFile = File(...)):
    ...
    return process_image_file(plate_detector, character_detector, contents, file.filename)
...
async def process_video_endpoint(file: UploadFile = File(...)):
    ...
    try:
        ...
        return process_video_file(plate_detector, character_detector, temp_video_path)
    finally:
